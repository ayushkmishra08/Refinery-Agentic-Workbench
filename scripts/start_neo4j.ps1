...
#
#   powershell -ExecutionPolicy Bypass -File scripts\start_neo4j.ps1            # console (foreground)
#   powershell -ExecutionPolicy Bypass -File scripts\start_neo4j.ps1 -Detached  # background window
#
