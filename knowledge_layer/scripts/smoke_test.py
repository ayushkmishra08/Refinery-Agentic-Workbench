...
def main():
    ...
    try:
        from knowledge_layer.schemas.parsed_document import ParsedDocument, ParsedPage, ParsedElement, ParsedTable, ParsedTableCell, ElementType
        from knowledge_layer.schemas.normalized_document import NormalizedDocument, NormalizedElement, ContentType
        from knowledge_layer.schemas.knowledge import DocumentKnowledge, ExtractedEntity, EntityType, EntityDomain
        from knowledge_layer.schemas.claims import EngineeringClaim, ClaimCategory, CLAIM_UNIT_RULES
        from knowledge_layer.schemas.table_schema import ClassifiedTable, TableClassification
        from knowledge_layer.schemas.document_profile import DocumentProfile, DocumentType
        from knowledge_layer.schemas.glossary import DocumentGlossary, GlossaryEntry
        from knowledge_layer.schemas.validation import ValidationResult
        from knowledge_layer.schemas.ontology import RefineryOntology
    ...
    try:
        from knowledge_layer.validator import ExtractionValidator, _classify_unit
