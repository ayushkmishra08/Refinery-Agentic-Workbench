...
PARSING checkpoint so that `python -m knowledge_layer` skips straight to normalization.
"""
...
from knowledge_layer.checkpoint import PipelineCheckpoint, PipelinePhase  # noqa: E402
