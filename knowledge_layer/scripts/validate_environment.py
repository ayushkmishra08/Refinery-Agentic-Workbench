...
def check_schemas():
    from knowledge_layer.schemas.parsed_document import ParsedDocument
    from knowledge_layer.schemas.normalized_document import NormalizedDocument
    from knowledge_layer.schemas.knowledge import DocumentKnowledge
    from knowledge_layer.schemas.claims import EngineeringClaim
    from knowledge_layer.schemas.table_schema import ClassifiedTable
...
def check_source_modules():
    ...
    from knowledge_layer.checkpoint import PipelineCheckpoint
