...
from knowledge_layer.schemas.claims import EngineeringClaim, ResolutionStatus, leading_number
from knowledge_layer.schemas.knowledge import ChunkExtraction, ExtractedEntity
from knowledge_layer.schemas.validation import ValidationResult
from knowledge_layer.entity_resolver import EntityResolver, Resolution
from knowledge_layer.memory import Neo4jMemory
from knowledge_layer.validator import normalize_unit, pressure_basis
...
class GraphInserter:
    ...
    def _resolve(self, name: str, document_id: str, canonical_name: str = "",
        ...
        if self.resolver is None:
            from knowledge_layer.entity_identity import document_scoped_uid
    ...
    def _ensure_trains(self, res: Resolution, extraction: ChunkExtraction, entity_payload: dict) -> None:
        ...
        if ident is None:
            return
        from knowledge_layer.entity_identity import entity_uid
        scope = self._scope()
        base = {
