...
from knowledge_layer.retriever import RetrievalContext
...
def _claim_context_fields(c: dict, chunk) -> dict:
    ...
    from knowledge_layer.spec_claims import operating_mode_for
...
class OllamaExtractor:
    ...
    def extract_relationships(
        ...
        from knowledge_layer.schemas.knowledge import ExtractedRelationship, RelationshipType
    ...
    def _parse_extraction(
        ...
        for raw_e in _lookup_list(data, "entities", "entity"):
            from knowledge_layer.schemas.knowledge import ExtractedEntity, EntityType, EntityDomain
        ...
        # Parse claims
        for c in _lookup_list(data, "claims", "claim"):
            from knowledge_layer.schemas.claims import EngineeringClaim, ClaimCategory
            if not isinstance(c, dict):
                continue
            try:
                raw_cpred = str(c.get("predicate") or "generic_property")
