...
import pytest
from knowledge_layer.schemas.claims import ClaimCategory, UnitFamily, CLAIM_UNIT_RULES, VALID_UNITS
from knowledge_layer.schemas.knowledge import RelationshipType, EntityType
...
class TestRelationshipDomainValidation:
    ...
    def test_motor_cannot_suction(self):
        ...
        from knowledge_layer.validator import IMPOSSIBLE_RELATIONSHIPS
    ...
    def test_product_feeds_is_suspicious(self):
        ...
        from knowledge_layer.validator import SUSPICIOUS_RELATIONSHIPS
